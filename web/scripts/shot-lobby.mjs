...
// Statistik-Screen (Stats.tsx): fuer das Board selbst gibt es scripts/shot-stats.mjs (Format-Schalter,
// Deckwahl, Deckanalyse, aufgeklappte Zeitachse). Hier bleibt nur der Weg fuer Einzelzustaende der Liste:
// --apply=fixtures/matches.json --click="text=Statistik"; ein weiteres --click=".match-filter input"
// schaltet den Filter "nur gewertete" ab, --click=".match-row .delete" zeigt den Papierkorb im
